...
# Computes the Mean Squared Error for predicted values against actual values
...
# Computes Normalized Root Mean Square Error (NRMSE) for predicted values against actual values
